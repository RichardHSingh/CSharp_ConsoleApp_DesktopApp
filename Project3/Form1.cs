...
namespace Project3
{
    public partial class Form1 : Form
    {
        ...
        private void btnSignIn_Click(object sender, EventArgs e)
        {
            ...
            else if (int.TryParse(visitorsMobileTB.Text, out num) == false)
            {
            ...
            else
            {
                ...
                visitorsOnSiteLB.Items.Add("Email: " + visitorsEmailAddressTB.Text);
                visitorsOnSiteLB.Items.Add("Mobile: " + visitorsMobileTB.Text);
                visitorsOnSiteLB.Items.Add("Date: " + dateTimePicker1.Text);
            ...
            //e contains a lot of information - allows one to manipulate the "e"
        }
...
//in the selection mode it is currently seetto one so that only 1 item gets deleted.. change to multisimple to make multiple lines being able to delete
            //clearing the field
        ...
        private void deleteLB(object sender, KeyEventArgs e)
        {
            ...
            {
                //can use while as statement is true.
                while (visitorsOnSiteLB.SelectedItems.Count > 0)
                {
